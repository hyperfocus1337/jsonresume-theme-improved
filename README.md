# Hyperfocus improved theme for jsonresume [![npm version](https://badge.fury.io/js/jsonresume-theme-jdambron.svg)](https://badge.fury.io/js/jsonresume-theme-jdambron)
